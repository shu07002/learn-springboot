...
public class QuizControllerTest {
    ...
    @DisplayName("quiz(): POST /quiz?code=1 이면 응답 코드는 403, 응답 바디는 Forbidden!을 리턴한다.")
    @Test
    ...
    @DisplayName("quiz(): POST /quiz?code=13 이면 응답 코드는 200, 응답 바디는 OK!를 리턴한다.")
    @Test
    void postQuiz13() throws Exception {
        final String url = "/quiz";
